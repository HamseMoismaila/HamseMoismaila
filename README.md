...
*   **[AgenOS](https://github.com/HamseMoismaila/HamzeOS)** — A Developer Agent Operating System (AOS) featuring a Context Routing Engine and Objective Gates to transform probabilistic LLM runs into deterministic, safe execution environments.
...
| Domain | Technologies |
| :--- | :--- |
| **Agentic Engineering** | Model Context Protocol (MCP), Google ADK 2.0, Agent CLI, Context Routing, AI Evaluation Sets |
| **Data Engineering** | SQL, PostgreSQL, SQLite, MySQL, SingleStore, ETL Pipelines |
